        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(RagisterActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    hashMap.put("bio","");
                    hashMap.put("imageurl","https://firebasestorage.googleapis.com/v0/b/cloneappinstagram-83b00.appspot.com/o/placeholder.png?alt=media&token=8aa23278-f3a9-4053-a81b-19313d0ed905");
